...
class UpdateSalesTransactionRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            ...
            $salesTransaction = $this->route('sales_transaction');

            if ($salesTransaction && $salesTransaction->product_id === $productId) {
                $availableStock = $product->stock + $salesTransaction->qty;
            } else {
